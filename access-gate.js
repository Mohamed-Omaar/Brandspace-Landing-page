(() => {
  ...
  const loadBranding = () => {
    if (!document.querySelector('link[data-bs-preview-branding]')) {
      ...
      branding.href = '/preview-branding.css?v=1';
      branding.dataset.bsPreviewBranding = '1';
    ...
    favicon.href = '/brandspace-logo.svg?v=1';
    favicon.dataset.bsPreviewFavicon = '1';
  ...
  gate.innerHTML = `
    <form class="bs-gate-card" id="bsGateForm" autocomplete="off">
      <div class="bs-gate-brand"><span class="bs-gate-mark" aria-hidden="true"></span><span>BrandSpace</span></div>
